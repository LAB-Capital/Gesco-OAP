...
def load_from_local_respuestas_resultados():
    ...
    resultados_2019_df = pd.read_excel(f"./files{UBI_AR['resultados_2019']}")
    resultados_2021_df = pd.read_excel(f"./files{UBI_AR['resultados_2021']}")
    resultados_2023_df = pd.read_excel(f"./files{UBI_AR['resultados_2023']}")
